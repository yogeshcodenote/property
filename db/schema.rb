...
ActiveRecord::Schema[8.0].define(version: 2026_02_27_115936) do
  ...
  create_table "buyers", force: :cascade do |t|
    ...
    t.index ["phone"], name: "index_buyers_on_phone"
  ...
  create_table "properties", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["colony_name"], name: "index_properties_on_colony_name"
    t.index ["plot_number"], name: "index_properties_on_plot_number"
